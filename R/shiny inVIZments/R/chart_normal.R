...
chart_normal_UI <- function(id){
  dygraphOutput(NS(id, "TA_chart_normal"), height = 300)
}

chart_normal_server <- function(id, ticker, period, start_dt, end_dt, dygrp){
  moduleServer(id, function(input, output, session){
    
    output$TA_chart_normal <- renderDygraph({
